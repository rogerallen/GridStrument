...
public class GridLines {
    ...
    private ArrayList<Float> mCoords = new ArrayList<Float>();

    private float mColor[] = new float[4]; // initialize this in constructor.
    private float mMMatrix[] = new float[16]; // initialize this in constructor.
    ...
    private void setup() {
        ...
        short drawOrder[] = new short[mCoords.size()];
        for(short i = 0; i < mCoords.size(); i++) {
            drawOrder[i] = i;
        }
    ...
    public void draw(float[] vpMatrix) {
        ...
        GLES20.glDrawElements(
                GLES20.GL_LINES, mCoords.size()/2,
